...
const EmpMoneyRequest = () => {
  ...
  return (
    <div className="p-6 bg-white rounded shadow-md max-w-4xl mx-auto mt-10">
        <div className="bg-gray-300 px-6 py-4 rounded-lg font-semibold text-lg text-center shadow-md shadow-gray-400 ">Employee Advance Money Request</div>
      ...
      <table className="w-full table-auto border-b border-gray-200 ">
        ...
        <tbody>
          {employees.map((emp, index) => (
            <tr key={index} className={`border-t border-gray-300 ${index %2 == 0? "bg-white":"bg-gray-100"}`}>
              ...
              <td className="px-4 py-4 text-gray-500">No advance requests.</td>
            </tr>
          ))}
        </tbody>
      </table>
