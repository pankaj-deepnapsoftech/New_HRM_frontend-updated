...
const EmpLocation = () => {
  return (
    <div  className="p-4 bg-gray-50 rounded shadow-md max-w-5xl mx-auto mt-10">
         ...
         <div className="bg-gray-300 text-gray-600 text-center py-4 mx-10 mb-10 rounded-xl shadow-md shadow-gray-400">
           ...
           <tbody>
             {employees.map((emp, idx) => (
               ...
               <tr key={idx} className={`border-t border-gray-200 ${idx%2==0? "bg-white":'bg-gray-100'}`}>
                 ...
                 <td className="p-2 px-3 text-blue-700 cursor-pointer">View<br />Location</td>
