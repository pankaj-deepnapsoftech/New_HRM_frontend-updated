...
const MainDashboardPage = () => {
 ...
 const statsCards = [
  ...
  <div className=" bg-gray-100 flex flex-col lg:flex-row gap-2  pt-3 md:pt-10  md:pb-6 items-start">
    <div className="flex  flex-wrap  gap-2 md:gap-4 ml-3 md:ml-4 ">
    {statsCards.map((card, i) => (
      <div
        key={i}
        className="bg-white rounded-sm shadow-md w-80 h-48 md:w-60 md:h-40 p-6  flex flex-col gap-5 text-gray-800"
      >
