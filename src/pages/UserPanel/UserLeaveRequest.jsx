    ...
    <div className="min-h-screen bg-gray-100 p-10">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className="bg-[#2563eb] text-white px-4 py-2 rounded transition hover:bg-[#143680]"
        >
          Add Leave Request
        </button>
      </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="text-center">
                      <button
                        type="submit"
                        disabled={isLoading}
                        className={`bg-[#2563eb] hover:scale-105 text-white font-semibold px-6 py-2 rounded-md transition ${
