            ...
            >
              {plan.recommended && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#2563eb] text-white text-xs font-semibold">
              ...
              <div>
                ...
                {plan.subNote && (
                  <p className="mt-2 text-sm text-gray-600">{plan.subNote}</p>
                )}
                <p className="mt-4 text-sm text-gray-600">
                  {plan.name} — choose what suits you best.
                </p>
              ...
              <div className="mt-6">
                <button
                  className={`w-full py-2 rounded-md font-semibold ${
                    plan.recommended
                      ? "bg-[#2563eb] text-white hover:bg-[#143680]"
