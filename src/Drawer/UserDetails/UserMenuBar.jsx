...
const UserMenuBar = ({ showUserMenuBar, setShowUserMenuBar }) => {
  ...
  return (
    <>
      ...
      <div className={` ${showChangePassPage ? "opacity-100 visible" : "opacity-0 invisible"} fixed inset-0 z-60 bg-black/40 flex items-center justify-center transition-opacity duration-300`}>
