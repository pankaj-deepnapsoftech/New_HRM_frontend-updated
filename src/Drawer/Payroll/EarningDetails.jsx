...
const EarningDetails = ({
  ...
  return (
    <section
      className={`${
        showEarningDetails ? "opacity-100 visible" : "opacity-0 invisible"
      } fixed top-0 left-0 h-screen w-full flex items-center justify-center bg-black/40  transition-opacity duration-500 ease-in-out`}
    >
        ...
        <div className="space-y-4 text-base text-gray-700">
          <div className="flex justify-between">
            ...
            <span className="font-medium">
              ₹ {earningDetails.basic.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between text-red-600">
            <span>Fund (12%)</span>
            <span className="font-medium">
              ₹ {earningDetails.fund.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Incentives</span>
            <span className="font-medium">
              ₹ {earningDetails.incentives.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Reimbursement</span>
            <span className="font-medium">
              ₹ {earningDetails.reimbursement.toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span>Advance</span>
            <span className="font-medium">
              ₹ {earningDetails.advance.toFixed(2)}
            </span>
          </div>
